...
const Showcase = () => {
  return (
    <div className="container mx-auto max-w-[1300px] px-4 pb-20">
      <div className="flex flex-col-reverse items-center justify-between space-y-4 md:flex-row md:space-y-0 md:space-x-5">
         <div>
            ...
            <h1 className="text-DarkBlue text-3xl font-bold md:text-5xl ">Bring everyone together to build better products.</h1>
